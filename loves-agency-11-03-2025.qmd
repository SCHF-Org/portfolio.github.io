...
abstract: "Here, I develop an account divinely inspired reflections of agency. Famously, Miranda Fricker develops an account of epistemic injustice that involves both testimony and hermeneutics. I highlight a less discussed form of epistemic injustice by noting a key difference in how regret is expressed in some popular songs. But what I am concerned with has to do with a specific kind of harm done to someone's capacity not as a knower, but their capacity as a 'moral' knower where 'moral' knower has to do with moral self-knowledge, virtues, vices, and values that are attributed, or are not, to the victim."
