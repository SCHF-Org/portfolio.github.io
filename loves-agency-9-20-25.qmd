...
abstract: "With respect to personal identity, both Roman Altshuler and Christine Korsgaard argue we are defined by the stories we accept about ourselves. If their account is what narrative in the psychological sense is, then we ought to recognize them as a ubiquitous artifact in much of what we recognize as modern and popular artworks, what I call Generic Representation. Following Paul Goldie, my account of Robust representation on the other hand, is grounded in feelings of regret. Narratives about our relationships with others and God as seen through experiences of regret, can help us to preserve an authentic account of personhood."
...
With respect to personal identity, both Roman Altshuler and Christine Korsgaard argue we are defined by the stories we accept about ourselves. On Korsgaard’s account, we select various events from our past and weave it into our own constructed narratives.

For Altshuler, this account neglects the affect that some events have on the construction of our past selves because it neglects those experiences we have but do not consciously weave into our narratives. Altshuler suggests several ways in which we might include these experiences into our self-constitution. I focus on one of these, those experiences we have that lead to regret. I argue that if this is what narrative in the psychological sense is, then we ought to recognize them as a ubiquitous artifact in much of what we recognize as modern and popular artworks, what I call Generic Representation.
...
I first make a distinction between generic and robust ethnic representation and show that generic representation is maximally corrosive to personal identity while robust representation is formative. So while one may argue that any representation is better than none, I argue that this view ignores the complexity of representation and identity. My account of Robust representation is one that is grounded in feelings of regret.
